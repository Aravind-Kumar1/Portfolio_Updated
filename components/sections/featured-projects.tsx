      ...
      <section className="min-h-[70vh] mt-4 bg-black py-6 sm:py-12 lg:py-16 relative overflow-hidden" style={{ fontFamily: 'Poppins, sans-serif' }}>
        ...
        <div className="container mx-auto px-3 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-4 sm:gap-8 lg:gap-12 items-stretch">
            ...
            <Card className="bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-xl relative overflow-hidden rounded-2xl shadow-xl border-0 min-h-[320px] sm:min-h-[400px] lg:min-h-[450px]">
              ...
              <CardContent className="p-4 sm:p-8 lg:p-12 relative z-10 h-full flex flex-col">
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <h2 className="text-lg sm:text-2xl lg:text-5xl font-semibold leading-tight text-gray-300 lg:text-left">
                    Where Passion Meets
                    <br />
                    <span className="text-gray-300">Precision</span>
                  </h2>

                  <div className="space-y-3 text-gray-300 leading-relaxed text-sm sm:text-base lg:text-lg lg:text-left">
                    <p>
            ...
            <div className="grid grid-cols-2 mt-[-5px] gap-2 sm:gap-4 lg:gap-6 h-full pt-4 sm:pt-6 lg:pt-8 px-2 sm:px-0">
              {achievements.map((achievement, index) => (
                  <Card
                      key={index}
                      className="relative overflow-hidden flex items-center justify-center h-24 sm:h-36 lg:h-48 mobile-achievement-card"
                      style={{
                  ...
                  >
                    ...
                    <CardContent className="p-2 sm:p-4 text-center relative z-10 w-full h-full flex flex-col justify-center">
                      <div className="space-y-1 sm:space-y-2">
                        ...
                        <div
                            className="text-lg sm:text-3xl lg:text-5xl font-bold text-white"
                            style={{
